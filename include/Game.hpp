...
public:
  ...
  Vector2 m_window_draw_offset; // TODO: this is just a quick patch to be able
                                // to create a screen shake effect, there must
                                // be a cleaner way
  Game();
  virtual void draw() = 0;
  virtual void update() = 0;
  virtual void run() = 0;
  std::optional<const Scene *const> current_scene() const;
