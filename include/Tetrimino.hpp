...
const ShapeInfo I_info = {0xf0, 0x2222, 0xf0, 0x2222, 'I'};
const ShapeInfo O_info = {0x660, 0x660, 0x660, 0x660, 'O'};
const ShapeInfo T_info = {0xe40, 0x4c40, 0x4e00, 0x4640, 'T'};
const ShapeInfo S_info = {0x6c0, 0x4620, 0x6c0, 0x4620, 'S'};
const ShapeInfo Z_info = {0xc60, 0x2640, 0xc60, 0x2640, 'Z'};
const ShapeInfo J_info = {0xe20, 0x44c0, 0x8e00, 0x6440, 'J'};
const ShapeInfo L_info = {0xe80, 0xc440, 0x2e00, 0x4460, 'L'};

const std::unordered_map<char, ShapeInfo> ShapeInfoList = {
    {'I', I_info}, {'O', O_info}, {'T', T_info}, {'S', S_info},
    {'Z', Z_info}, {'J', J_info}, {'L', L_info}};
