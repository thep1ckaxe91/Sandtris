...
namespace sdlgame::surface
{
     ...
     */
    void Surface::blit(const Surface &source, sdlgame::math::Vector2 pos, sdlgame::math::Vector2 size, sdlgame::rect::Rect area)
    {
    ...
    sdlgame::math::Vector2 Surface::get_size() const
    {
        return size;
    }
